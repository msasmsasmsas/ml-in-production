...
class PredictionRequest(BaseModel):
    """
    Р—Р°РїРёС‚ РЅР° РїРµСЂРµРґР±Р°С‡РµРЅРЅСЏ (РІРёРєРѕСЂРёСЃС‚РѕРІСѓС”С‚СЊСЃСЏ РґР»СЏ РґРѕРєСѓРјРµРЅС‚Р°С†С–С— API)
    """
    threshold: Optional[float] = Field(0.5, description="РџРѕСЂС–Рі РІРїРµРІРЅРµРЅРѕСЃС‚С– (0-1)")
